    ...
    <SafeAreaView className="bg-white h-full">
        ...
        <View className='my-5'>
            <View className="flex flex-row items-center justify-between">
                <Text className="text-xl font-rubik-semibold text-black-300">Featured</Text>
                <TouchableOpacity >
            ...
            renderItem={({item})=> <FeaturedCard item={item} onPress={() => handlePressCard(item.$id)}  />  }
            keyExtractor={(item) => item.$id}
            horizontal
            bounces={false}
            ...
            <View className="flex flex-row items-center justify-between">
                <Text className="text-xl font-rubik-semibold text-black-300">Our Recommendations</Text>
                <TouchableOpacity >
                    <Text className="text-base font-rubik-bold text-primary-300">See All</Text>
                </TouchableOpacity>
            </View>
